    ...
    <div>
      <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm'>
        <div>
            ...
            <p className='w-full md:w-2/3 text-gray-600'>The Gavai Swad Agro Products P Limited (Gavai Swad) is a company founded in 2020 during the
...
made out of desi raw material. </p>
        </div>
        <div>
